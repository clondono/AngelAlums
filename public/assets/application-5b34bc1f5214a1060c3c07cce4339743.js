...
(function() {
  ...
  jQuery(function() {
    ...
    return donation.setupForm();
  });

  donation = {
    setupForm: function() {
      return $('#new_donation').submit(function() {
        $('input[type=submit]').attr('disabled', true);
        return donation.processCard();
      });
    },
    processCard: function() {
      ...
      return Stripe.card.createToken(card, donation.handleStripeResponse);
    },
